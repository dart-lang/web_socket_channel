...
class _CryptoUtils {
  ...
  static List<int> base64StringToBytes(String input, [bool ignoreInvalidCharacters = true]) {
...
abstract class _HashBase {
  ...
  _HashBase(this._chunkSizeInWords, this._digestSizeInWords, this._bigEndianWords)
      : _pendingData = [] {
