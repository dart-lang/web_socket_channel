...
class CompressionOptions {
  ...
  _CompressionMaxWindowBits _createHeader([HeaderValue requested]) {
    ...
    if (clientNoContextTakeover &&
        (requested == null ||
            (requested != null && requested.parameters.containsKey(_clientNoContextTakeover)))) {
      info.headerValue += "; client_no_context_takeover";
    }

    if (serverNoContextTakeover &&
        (requested == null ||
            (requested != null && requested.parameters.containsKey(_serverNoContextTakeover)))) {
...
abstract class WebSocket
    implements Stream<dynamic /*String|List<int>*/ >, StreamSink<dynamic /*String|List<int>*/ > {
  /**
  ...
  static Future<WebSocket> connect(String url,
      ...
      _WebSocketImpl.connect(url, protocols, headers,
          compression: compression, badCertificateCallback: badCertificateCallback);
